    ...
    <el-dialog :visible="centerDialogVisible" @close="$emit('closeDialog', false)">
        ...
        <el-form :model="objectInfoForm">
            <el-form-item label="标签名字">
                <el-input @input="forceUpdate" type="text" v-model="objectInfoForm.tagName" placeholder="请输入分类名字"
                    clearable />
            </el-form-item>
            <el-form-item label="标签描述">
                <el-input @input="forceUpdate" type="textarea" v-model="objectInfoForm.tagDesc" placeholder="请输入分类描述"
                    clearable />
            </el-form-item>
        </el-form>
        <template #footer>
