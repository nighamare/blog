...
<div class="common-table">
    ...
    :loading="true" type="index" :row-class-name="tableRowClassName"
     @selection-change="handleSelectChange">
        <el-table-column type="selection" width="55">
        </el-table-column>
        <el-table-column type="index" width="50" label="序号">
        </el-table-column>
        <el-table-column v-for="(column, index) of columns"  resizable :show-overflow-tooltip='true'  :prop="column.prop" :label="column.label" :key="index" header-align="center">
        ...
        <el-table-column prop="action" header-align="center"  label="操作" fixed="right" width="200" resizable>
             <template #default="scope">
